...
public class ServiceDefaultsConfigurationBeanImpl implements ServiceDefaultsConfigurationBean {
    ...
    private final ServiceDefaultsConfiguration serviceDefaultsContext;
    private final GatewayManagementBean gatewayBean;
    private final int id;

    public ServiceDefaultsConfigurationBeanImpl(ServiceDefaultsConfiguration serviceDefaultsContext, GatewayManagementBean
            gatewayBean) {
    ...
    public String getAcceptOptions() {
        ...
        Map<String, String> context = serviceDefaultsContext.getAcceptOptions();
        try {
            if (context != null) {
                // DPW TODO
